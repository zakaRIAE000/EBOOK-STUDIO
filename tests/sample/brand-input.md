...
**Book title (required):** Smoke Test Book

**Subtitle:** 

**Author / brand name (required):** Ebook Studio QA

**Target reader (required):** Anyone verifying the pipeline still works.
<!-- one or two sentences: who is this book for -->

**Tone (required):** neutral
